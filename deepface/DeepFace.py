...
def find(
    ...
    if path.exists(db_path + "/" + file_name):
        ...
        for index in pbar:
            ...
            print(f"Finding representations for {employee}")
            img_objs = functions.extract_faces(
                img=employee,
                target_size=target_size,
                detector_backend=detector_backend,
...
# Optimized to use face object fromm extract_face
def find_w_face(
    face,
    db_path,
    model_name="VGG-Face",
    ...
    print ("entering faces loop")

    target_img = face["face"]
    target_region = face["facial_area"]
